...
function showAgyPrerequisiteWarning(attemptedCmd) {
  ...
  console.log(yellowBox('================================================================================'));
  console.log();
  console.log(whiteBold('  Die AI Offer Pipeline funktioniert ausschließlich'));
  ...
  console.log(chalk.yellow('  kannst du mit den Befehlen der ai-offer-pipeline chatten und die'));
  console.log(chalk.yellow('  Offer-Forge- und Growth-Audit-Prozesse bedienen.'));
  console.log();
  ...
  console.log(whiteBold('     In Antigravity kannst du interaktiv mit den Offer Pipeline Agenten'));
  console.log(whiteBold('     chatten und sämtliche Audit- und Proposal-Workflows steuern.'));
  console.log();
  console.log(yellowBox('================================================================================'));
...
program
  ...
  .description('Autonomous AI Agent for Google Ads Growth Audits & Client Offer Generation (requires Antigravity CLI)')
  .version('1.0.0')
